        ...
        <div className="bg-background-dark font-display text-slate-100 min-h-screen relative overflow-hidden schematic-bg flex flex-col items-center justify-center p-6">
            ...
            <div className="mb-8 flex flex-col items-center z-10">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-black tracking-[0.3em] text-white">SYSTEM_INIT</h1>
                </div>
                ...
                <form className="p-8 space-y-8" onSubmit={handleSubmit}>
                    <section className="space-y-6">
                        <div className="flex items-center gap-2 border-l-2 border-primary pl-4">
                            <h3 className="text-white text-xs font-black tracking-widest uppercase">IDENTITY_SETUP</h3>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Legal_Name (Name)</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Uplink_Email</label>
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center gap-2 border-l-2 border-white/20 pl-4">
                            <h3 className="text-white text-xs font-black tracking-widest uppercase">SECURITY_ENCRYPTION</h3>
                        </div>
                        <div className="space-y-2">
                            <label className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Access_Key_Hash (Password)</label>
                            <input
                                className="bg-[#0f0f0f] border border-white/10 text-white text-xs font-mono px-4 py-3 w-full focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all"
                                placeholder="••••••••••••"
                                type="password"
                    ...
                    <section className="space-y-6">
                        <div className="flex items-center gap-2 border-l-2 border-white/20 pl-4">
                            <h3 className="text-white text-xs font-black tracking-widest uppercase">PROJECT_CONTEXT</h3>
                        </div>
                        <div className="space-y-2">
