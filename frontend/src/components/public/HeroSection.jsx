...
const HeroSection = () => {
    return (
        <section className="relative min-h-screen flex flex-col items-center lg:pb-20 overflow-hidden">
            <div className="lg:absolute m-10 lg:m-0 lg:right-0 lg:top-1/2 lg:-translate-y-1/2 w-[70vw] lg:w-1/2 h-[40vh] lg:h-4/5 opacity-80 lg:opacity-40 mix-blend-screen lg:block">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 w-full">
                <div className="flex flex-col gap-12 max-w-4xl">
                    <div className="flex items-center gap-4 text-primary font-bold text-xs tracking-[0.4em] uppercase">
                        <span className="h-6 lg:h-8 w-[1px] bg-primary animate-pulse"></span>
                        Full Stack Engineer
                    </div>
