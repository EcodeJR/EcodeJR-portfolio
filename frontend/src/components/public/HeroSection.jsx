                ...
                <div className="flex flex-col gap-12 max-w-4xl">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-8 mt-4">
                        <p className="text-zinc-500 max-w-sm text-lg leading-relaxed border-l-2 border-primary/30 pl-6">
                            MERN Stack development refined through tech-wear aesthetics and high-performance engineering.
                        </p>
                        <div className="flex gap-4">
                            ...
                            <div className="flex flex-col justify-center">
                                ...
                                <span className="text-sm font-display font-bold">NEURO_INTERFACE_V2</span>
                            </div>
                        </div>
                    </div>
                </div>
