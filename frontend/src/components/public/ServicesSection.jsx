            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                    <div className="max-w-xl">
                        ...
                        <h3 className="text-4xl md:text-6xl font-display font-bold tracking-tighter uppercase leading-none">High-Tech<br />Implementations</h3>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {services.map((service) => (
                        <div key={service.id} className="group tech-card bg-surface-dark p-10 border border-white/5 hover:border-primary/50 transition-all flex flex-col h-[400px]">
